 ...
 */
enum HtmlTreeBuilderState2 {
    Initial {
        boolean process(Token t, HtmlTreeBuilder2 tb) {
            if (isWhitespace(t)) {
    ...
    BeforeHtml {
        ...
        private boolean anythingElse(Token t, HtmlTreeBuilder2 tb) {
    ...
    InBody {
            ...
            switch (t.type) {
                ...
                case StartTag:
                    ...
                    if (name.equals("a")) {
                        ...
                        HtmlTreeBuilderState2 state = tb.state();
        ...
        boolean anyOtherEndTag(Token t, HtmlTreeBuilder2 tb) {
    ...
    InTable {
        ...
        boolean anythingElse(Token t, HtmlTreeBuilder2 tb) {
            tb.error(this);
            boolean processed;
    ...
    InTableBody {
        ...
        private boolean exitTableBody(Token t, HtmlTreeBuilder2 tb) {
    ...
    InCell {
        ...
        private void closeCell(HtmlTreeBuilder2 tb) {
    ...
    abstract boolean process(Token t, HtmlTreeBuilder2 tb);
    ...
    private static void handleRcData(Token.StartTag startTag, HtmlTreeBuilder2 tb) {
        tb.insert(startTag);
        tb.tokeniser.transition(TokeniserState.Rcdata);
        tb.markInsertionMode();
        tb.transition(Text);
    ...
    private static void handleRawtext(Token.StartTag startTag, HtmlTreeBuilder2 tb) {
        tb.insert(startTag);
